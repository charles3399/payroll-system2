<template>
    ...
    <div class="p-2 mx-4 2xl:mx-64 xl:mx-64 lg:mx-64 my-2">
        ...
        <div class="my-2 px-5 py-3 bg-gray-700 rounded-lg">
            ...
            <h3 class="my-2 text-xl tracking-wider">Basic Pay: {{ position.basic_pay }}</h3>
            <router-link :to="{ name: 'positions.edit', params: { id: position.id } }" class="my-2 px-3 py-1 text-sm bg-green-500 hover:bg-green-700 transform duration-200 font-bold tracking-wider rounded-lg">Edit</router-link>
        </div>
    </div>
</template>
