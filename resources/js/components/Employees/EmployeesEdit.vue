<template>
    <h1 class="text-2xl tracking-wide text-center">Edit Employee</h1>
    <div class="p-2 mx-5">
        ...
        <div class="my-2 px-5 py-3 bg-gray-700 rounded-lg">
            ...
            <form @submit.prevent="saveEmployee">
                <div class="p-5">
                    ...
                    <input type="text" name="full_name" id="full_name" class="form-input block p-1 mb-2 w-full border-0 border-b-2 bg-gray-700 focus:ring-0 focus:border-white text-white" v-model="employee.full_name">
                </div>
                <div class="p-5">
                    <label for="email" class="font-bold tracking-wider">E-mail</label>
                    <input type="email" name="email" id="email" class="form-input block p-1 mb-2 w-full border-0 border-b-2 bg-gray-700 focus:ring-0 focus:border-white text-white" v-model="employee.email">
                </div>
                <div class="p-5">
                    <label for="address" class="font-bold tracking-wider">Address</label>
                    <input type="text" name="address" id="address" class="form-input block p-1 mb-2 w-full border-0 border-b-2 bg-gray-700 focus:ring-0 focus:border-white text-white" v-model="employee.address">
                </div>
                <div class="p-5">
                    <label for="gender" class="font-bold tracking-wider">Gender</label>
                    <input type="text" name="gender" id="gender" class="form-input block p-1 mb-2 w-full border-0 border-b-2 bg-gray-700 focus:ring-0 focus:border-white text-white" v-model="employee.gender">
                </div>
                <div class="p-5">
...
<script>
    ...
    export default {
        ...
        setup(props) {
            const { errors, employee, getEmployee, updateEmployee } = useEmployee()
