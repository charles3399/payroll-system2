<template>
    <h1 class="text-2xl tracking-wide text-center">Payroll for: {{ payroll.employee[0].full_name }}</h1>
    <div class="p-2 mx-4 2xl:mx-64 xl:mx-64 lg:mx-64 my-2">
        ...
        <div class="my-2 px-5 py-3 bg-gray-700 rounded-lg">
            ...
            <h3 class="my-2 text-xl tracking-wider">Employee: {{ payroll.employee[0].full_name }}</h3>
            <h3 class="my-2 text-xl tracking-wider">Position: {{ payroll.employee[0].position.position_name }}</h3>
            <h3 class="my-2 text-xl tracking-wider">Basic pay: {{ payroll.employee[0].position.basic_pay }}</h3>
        ...
        <div class="my-2 px-5 py-3 bg-gray-700 rounded-lg">
            ...
            <table class="table-auto text-center mb-3 bg-slate-500 rounded-lg">
                ...
                <table class="table-auto text-center mb-3 bg-slate-500 rounded-lg">
                    ...
                    <tbody>
                        <tr>
                            <td class="p-2">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).sss) }}</td>
                            <td class="p-2">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).hdmf) }}</td>
                            <td class="p-2">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).philhealth) }}</td>
                        </tr>
                    </tbody>
                </table>
                <table class="table-auto text-center mb-3 bg-slate-500 rounded-lg">
                    ...
                    <tbody>
                        <tr>
                            <td class="p-2">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).late_overall) }}</td>
                            <td class="p-2">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).absent_overall) }}</td>
                            <td class="p-2">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).total_deductions) }}</td>
                        </tr>
                    </tbody>
                </table>
                <div class="bg-slate-700">
                    <h4 class="text-lg">Total Pay for {{ payroll.employee[0].full_name }}: <strong class="font-bold text-2xl">{{ numberWithCommas(payrollCompute(payroll.employee[0].position.basic_pay, payroll.days_worked, payroll.overtime, payroll.bonuses, payroll.late, payroll.absences).net_pay) }}</strong></h4>
